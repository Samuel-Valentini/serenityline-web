  ...
  return (
    <div className="sl-public-layout">
      <header className="sl-public-topbar">
        ...
        <nav aria-label={t("navigationLabel")} className="sl-public-nav">
          <NavLink
            className={({ isActive }) =>
              isActive ? "sl-public-nav-link active" : "sl-public-nav-link"
            }
            end
        ...
        <div className="sl-public-actions">
          <Link className="btn btn-outline-primary btn-sm" to={ROUTES.auth.login}>
            {t("login")}
          </Link>

          <Link className="btn btn-primary btn-sm" to={ROUTES.auth.register}>
            {t("register")}
          </Link>
        </div>
      </header>
